...
**Setup panel – Simulated (GBM) mode (default):**

![Setup Simulated Mode](screenshots/setup-simulated-mode.png)

**Setup panel – Real Historical Prices mode (fetches from stooq.com):**

![Setup Real Historical Mode](screenshots/setup-real-historical-mode.png)

**Simulation running with real AAPL / MSFT / AMZN / GOOGL / META data:**

![Real Historical Simulation Running](screenshots/real-historical-simulation-running.png)
